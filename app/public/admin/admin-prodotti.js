...
document.addEventListener("critical-ready", () => {
  console.log("[ADMIN] Init admin-prodotti.js (SQL + Token Fix)");
  ...
  /* =========================================================
     1) CARICA LISTA PRODOTTI (con token)
  ========================================================== */
  async function caricaListaProdotti() {
    try {
      ...
      if (prodotti.length === 0) {
        listaBox.innerHTML = "<p>Nessun prodotto trovato (o accesso negato).</p>";
        return;
      }
