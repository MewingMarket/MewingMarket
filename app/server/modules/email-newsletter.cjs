...
<div style="font-family:Arial, sans-serif; max-width:600px; margin:0 auto; padding:20px; line-height:1.6;">
  ...
  <div style="text-align:left;">
    ...
    <a href="https://www.facebook.com/profile.php?id=61584779793628" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://www.threads.com/@mewingmarket" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/11428/11428186.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://www.instagram.com/mewingmarket" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://www.tiktok.com/@mewingmarket" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/3046/3046121.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://x.com/mewingm8" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/5968/5968958.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://www.youtube.com/@mewingmarket2" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/1384/1384060.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://www.linkedin.com/in/simone-griseri-5368a7394" target="_blank" style="margin-right:10px;">
      <img src="https://cdn-icons-png.flaticon.com/512/3536/3536505.png" width="32" style="vertical-align:middle;">
    </a>
    <a href="https://wa.me/393520266660" target="_blank">
      <img src="https://cdn-icons-png.flaticon.com/512/733/733585.png" width="32" style="vertical-align:middle;">
    </a>
...
`;
  ...
  return inviaEmailLista({
    email,
    listId: LISTA_NEWSLETTER,   // ID 8
    subject,
    html,
    sender: SENDER_NEWSLETTER   // vendite@mewingmarket.it
  });
}
